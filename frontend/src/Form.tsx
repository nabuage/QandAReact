...
export const Form: React.FC<Props> = ({ submitCaption, children, validationRules, onSubmit, submitResult, successMessage = "Success", failureMessage = "Something went wrong"}) => {
